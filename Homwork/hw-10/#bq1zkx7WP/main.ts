...
//
let price1: number= +(localStorage.getItem('price') || 0);
...
// минулий час візиту
let lastVisit1:number= +(localStorage.getItem('lastVisit') || 0);
...
let div1:HTMLElement = document.getElementById('price') as HTMLElement
